...
a = Analysis(
    ...
    binaries=[],
    # Put data(i.e. assets) under virtual 'modi2_network_nvs_reset/'
    datas=[
        ('modi2_network_nvs_reset/assets', 'modi2_network_nvs_reset/assets'),
        ('version.txt', '.')
    ],
    hiddenimports=[
        "modi2_network_nvs_reset.util.connection_util",
    ],
    hookspath=[],
    runtime_hooks=[],
    excludes=[],
